        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicoidCadastro = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgendasChatBot", x => x.idAgendaChatBot);
                    table.ForeignKey(
                        name: "FK_AgendasChatBot_Medicos_MedicoidCadastro",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgendasChatBot_MedicoidCadastro",
                table: "AgendasChatBot",
